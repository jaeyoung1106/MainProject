...
<body>
	<div id="article">
		<form id="registerForm" action="registerForm.do" method="post">
			<table>
				<tr>
				<td>아이디<td><input type="text" size="10" name="id">
							<input type="button" value="아이디중복확인"  onclick=""/>
				<tr>
				<td>비밀번호<td><input type="password" size="10" name="password" >
				<tr>
				<td>비밀번호질문
				<td>
				...
				<tr>
				<td>이메일<td><input type="email" size="15" name="email" />
						<td><input type="button" value="이메일 인증" onclick=""/>
						<!-- 인증버튼 클릭하면 text/ 시간표시 요소/ 인증확인 버튼 추가 -->
				<tr>
				<td>생일<td><input type="date" name="birth"/>
				<tr>
				<td>체형<td><input type="radio" name="body" value="마른" checked>마른&nbsp;
				...
				<tr><td><input type="submit" value="회원가입"/>
					<td><input type="button" value="취소" onclick="window.history.go(-1)"/>		
			</table>
		</form>
	</div>
</body>
